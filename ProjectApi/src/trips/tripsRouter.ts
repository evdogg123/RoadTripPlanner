...
export class TripsRouter extends AppRouter{
    ...
    setupRoutes(): void {      
        this.expressRouter.get('/trips',TripsRouter.tripsController.getTrips);
        this.expressRouter.get('/trips/:trip-id',TripsRouter.tripsController.getTrip);
       ...
       // this.expressRouter.post('/trips/:trip-id',[SecurityMiddleware.RequireAuth],TripsRouter.tripsController.addSubTrip);
        ...
        this.expressRouter.put('/trips/:trip-id',[SecurityMiddleware.RequireAuth],TripsRouter.tripsController.updateTrip);
